...
import com.puzderwav.app.data.search.SearchRepository
import com.puzderwav.app.data.search.SearchTab
import com.puzderwav.app.data.ytmusic.YtMusicLibraryManager
...
class AndroidAutoMediaLibrary @Inject constructor(
    ...
    private fun appIconUri(): Uri = Uri.parse(
        "android.resource://${context.packageName}/${com.puzderwav.app.R.drawable.ic_car_attribution}",
    )
    ...
    companion object {
        const val ROOT_ID = "PuzderWav_root"
