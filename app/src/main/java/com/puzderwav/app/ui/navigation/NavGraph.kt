package com.puzderwav.app.ui.navigation
...
import com.puzderwav.app.data.model.AuthState
import com.puzderwav.app.ui.auth.AuthViewModel
import com.puzderwav.app.ui.auth.LoginScreen
import com.puzderwav.app.ui.settings.SettingsScreen
import com.puzderwav.app.ui.search.SearchScreen
import com.puzderwav.app.ui.discover.DiscoverScreen
import com.puzderwav.app.ui.genres.GenresScreen
import com.puzderwav.app.ui.shell.MainShell
import com.puzderwav.app.ui.common.PredictiveBackScreen
import com.puzderwav.app.ui.common.ExpressiveLoadingIndicator
import com.puzderwav.app.ui.common.ExpressiveMotion
import com.puzderwav.app.ui.genres.GenreExplorer
...
/** Thin bridge so PuzderWavNavHost (a plain composable, no direct Hilt
...
@HiltViewModel
class MixLauncherNavBridge @Inject constructor(val mixLauncher: com.puzderwav.app.ui.generate.MixLauncher) : ViewModel()
...
class LaunchGateViewModel @Inject constructor(
    authRepository: com.puzderwav.app.data.repository.AuthRepository,
    sessionPreferences: com.puzderwav.app.data.local.SessionPreferences,
    ytAuthManager: com.puzderwav.app.data.ytmusic.YtMusicAuthManager,
) : ViewModel() {
    ...
    NavHost(
        ...
        composable(Screen.Login.route) {
            ...
            LaunchedEffect(gateTarget, webAuthState) {
                if (gateTarget == LaunchGateViewModel.GateTarget.MainShell &&
                    webAuthState == com.puzderwav.app.ui.auth.WebAuthState.Idle
                ) {
            ...
            val restoreError = (webAuthState as? com.puzderwav.app.ui.auth.WebAuthState.Error)?.message
            val restoring = webAuthState == com.puzderwav.app.ui.auth.WebAuthState.RestoringBackup
            LoginScreen(
                onLoginWithYouTube = {
        ...
        composable(Screen.Create.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.generate.GenerateScreen(
        ...
        composable(Screen.Friends.route) { backStackEntry ->
            ...
            val homeViewModel: com.puzderwav.app.ui.home.HomeViewModel = hiltViewModel(parentEntry)
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.home.FriendsScreen(
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.home.FriendProfileScreen(
                    username = username,
        ...
        composable(Screen.YouTubeImport.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.YouTubePlaylistImportScreen(
                    onBack = { navController.popBackStack() },
                    onImportSuccess = {
                        navController.popBackStack()
                    },
        ...
        composable(Screen.YouTubeLogin.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.YouTubeLoginScreen(
                    onBack = { navController.popBackStack() },
        ...
        composable(Screen.ExternalPlaylistImport.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.ExternalPlaylistImportScreen(
                    onBack = { navController.popBackStack() },
                    onImportSuccess = {
                        navController.popBackStack()
                    },
        ...
        composable(Screen.Downloads.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.DownloadsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ProviderModules.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.ModulesScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.HomeSections.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.HomeSectionsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ExcludedSongs.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.ExcludedSongsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ScrobblerApps.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.settings.ScrobblerAppsScreen(onBack = { navController.popBackStack() })
            }
        }
        ...
        composable(Screen.NewReleases.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.newreleases.NewReleasesScreen(
                    onBack = { navController.popBackStack() },
                )
            }
        }
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.feed.FeedPlaylistDetailScreen(
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.playlist.PlaylistDetailScreen(
                    playlistId = playlistId,
                    onBack = { navController.popBackStack() },
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.artist.ArtistDetailScreen(
        ...
        composable(
            ...
            val browseId = backStackEntry.arguments?.getString("browseId")?.takeIf(String::isNotBlank)
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.puzderwav.app.ui.album.AlbumDetailScreen(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Surface(
                ...
                androidx.compose.foundation.Image(
                    painter = painterResource(com.puzderwav.app.R.drawable.ic_launcher_foreground),
                    contentDescription = null,
                    modifier = Modifier.fillMaxSize(),
                )
            }
            Spacer(Modifier.height(18.dp))
            Text("PuzderWav", style = MaterialTheme.typography.headlineSmall)
