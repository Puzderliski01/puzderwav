package com.puzderwav.app.ui.home
...
import com.puzderwav.app.ui.common.HeaderActionIcon
...
import com.puzderwav.app.ui.theme.BadgePillShape
import com.puzderwav.app.ui.theme.ExpressiveHeroShape
import com.puzderwav.app.ui.theme.ExpressivePillShape
import com.puzderwav.app.ui.theme.HeroInnerShape
import com.puzderwav.app.ui.theme.ListContainerShape
import com.puzderwav.app.ui.theme.NowPlayingCardShape
import com.puzderwav.app.ui.theme.StatPillShape
import com.puzderwav.app.ui.theme.TrackRowShape
...
import com.puzderwav.app.data.repository.HomeAlbum
import com.puzderwav.app.data.repository.HomeArtistItem
import com.puzderwav.app.data.repository.HomeSortMode
import com.puzderwav.app.data.repository.HomeTrack
...
fun HomeScreen(
    ...
    artistAlbumNavigator: com.puzderwav.app.ui.navigation.ArtistAlbumNavigator = hiltViewModel<ArtistAlbumNavBridgeHome>().navigator,
) {
    ...
    Scaffold(
        ...
        if (uiState.isLoading) {
            Box(
                ...
                com.puzderwav.app.ui.common.ExpressiveLoadingIndicator(message = "Loading your listening history")
            }
            return@Scaffold
        }
        ...
        Box(
            ...
            PullToRefreshBox(
                ...
                val playbackQueue = remember(rows) {
                    rows.mapNotNull { row ->
                        (row as? HomeRow.Track)?.track?.let { track ->
                            com.puzderwav.app.playback.PlayableTrack(
                                title = track.name,
                                artist = track.artist,
                ...
                val musicPlayer = com.puzderwav.app.ui.player.LocalMusicPlayer.current
                val addToPlaylist = com.puzderwav.app.ui.player.LocalAddToPlaylist.current
    ...
    menuTrack?.let { track ->
        com.puzderwav.app.ui.common.TrackContextMenuSheet(
            target = com.puzderwav.app.ui.common.TrackMenuTarget.Track(track.name, track.artist, track.artworkUrl.orEmpty()),
            capabilities = com.puzderwav.app.ui.common.TrackMenuCapabilities(showCopyActions = true, showDeleteScrobble = true),
    ...
    Surface(
        ...
        Row(
            ...
            Box(
                ...
                ArtworkImage(
                    name = track.name,
                    artist = com.puzderwav.app.util.ArtistHelper.primaryArtist(track.artist),
                    embeddedUrl = track.artworkUrl,
                    fallbackIcon = if (isNowPlaying) Icons.Filled.GraphicEq else Icons.Filled.MusicNote,
                    modifier = Modifier.fillMaxSize(),
                )
                if (isNowPlaying) {
                    com.puzderwav.app.ui.player.PlayingWaveBars(
            ...
            Column(Modifier.weight(1f)) {
                ...
                val displayArtist = com.puzderwav.app.util.ArtistHelper.primaryArtist(track.artist)
            ...
            com.puzderwav.app.ui.common.OverflowMenuButton(onClick = onMenuClick)
        }
    }
}
    ...
    Surface(
        ...
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                val displayArtist = com.puzderwav.app.util.ArtistHelper.primaryArtist(album.artist)
                if (displayArtist.isNotBlank()) {
                    Spacer(Modifier.height(2.dp))
                    Text(
                        displayArtist,
