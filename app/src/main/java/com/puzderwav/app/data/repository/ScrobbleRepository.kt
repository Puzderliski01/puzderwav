...
import com.puzderwav.app.data.network.LastFmRateGuard
import com.puzderwav.app.data.network.LastFmSigner
...
/**
 * The two signed calls PuzderWav's own scrobbler (MediaScrobbleListenerService)
...
class ScrobbleRepository @Inject constructor(
    ...
    /** Mirrors PuzderWav's player heart to the authenticated Last.fm library. */
