package com.puzderwav.app.data.lyrics
...
class LyricsRepository @Inject constructor(
    ...
    suspend fun getLyrics(
        ...
        }.getOrDefault(com.puzderwav.app.data.local.LyricsProvider.AUTO)
        ...
        if (preferred == com.puzderwav.app.data.local.LyricsProvider.LRCLIB) {
    ...
    private suspend fun fetchPreferredWord(
        preferred: com.puzderwav.app.data.local.LyricsProvider,
        title: String,
        artist: String,
        album: String?,
        durationSeconds: Int?,
    ): LyricsResult.Success? = when (preferred) {
        com.puzderwav.app.data.local.LyricsProvider.APPLE_MUSIC ->
            appleMusicApi.fetchLyrics(title, artist, album, durationSeconds)
        com.puzderwav.app.data.local.LyricsProvider.LYRICS_PLUS ->
            fetchWordFromLyricsPlus(title, artist, album, durationSeconds)
        com.puzderwav.app.data.local.LyricsProvider.BETTER_LYRICS ->
            fetchWordFromBetterLyrics(title, artist)
        com.puzderwav.app.data.local.LyricsProvider.KUGOU ->
            fetchWordFromKugou(title, artist, durationSeconds)
        else -> null
    }
