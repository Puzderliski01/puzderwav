package com.puzderwav.app.di

import android.content.Context
import androidx.room.Room
import androidx.room.migration.Migration
import com.puzderwav.app.data.local.db.AppDatabase
import com.puzderwav.app.data.local.db.ArtworkCacheDao
...
object DatabaseModule {
    ...
    fun provideAppDatabase(@ApplicationContext context: Context): AppDatabase =
        Room.databaseBuilder(context, AppDatabase::class.java, "PuzderWav.db")
    ...
    @Provides
    @Singleton
    fun provideDownloadedTrackDao(database: AppDatabase): com.puzderwav.app.data.local.db.DownloadedTrackDao =
        database.downloadedTrackDao()

    @Provides
    @Singleton
    fun provideSongPlayStatsDao(database: AppDatabase): com.puzderwav.app.data.local.db.SongPlayStatsDao =
