...
import com.puzderwav.app.util.AppLocaleManager
import kotlinx.coroutines.flow.distinctUntilChanged
import kotlinx.coroutines.flow.drop
import kotlinx.coroutines.flow.map
import kotlinx.coroutines.launch
import com.puzderwav.app.data.repository.LastFmAuthCallbackCoordinator
import com.puzderwav.app.ui.navigation.PuzderWavNavHost
import com.puzderwav.app.ui.navigation.Screen
import com.puzderwav.app.ui.player.PlayerHost
import com.puzderwav.app.ui.theme.PuzderWavTheme
import com.puzderwav.app.ui.theme.ThemeViewModel
...
class MainActivity : androidx.fragment.app.FragmentActivity() {
    ...
    @Inject
    lateinit var linkPlaybackResolver: dagger.Lazy<com.puzderwav.app.playback.LinkPlaybackResolver>

    @Inject
    lateinit var appRouteNavigator: dagger.Lazy<com.puzderwav.app.ui.navigation.AppRouteNavigator>

    @Inject
    lateinit var settingsPreferences: com.puzderwav.app.data.local.SettingsPreferences
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            PuzderWavTheme(themeState = themeState) {
                ...
                PlayerHost(hasBottomNavigation = hasBottomNavigation) {
                    PuzderWavNavHost(navController)
                }
            }
        }
    }
            ...
            runCatching {
                ...
                if (hasAccess) {
                    android.service.notification.NotificationListenerService.requestRebind(
                        android.content.ComponentName(this, com.puzderwav.app.service.MediaScrobbleListenerService::class.java),
                    )
                }
            }
        }
    ...
    private fun handlePlaybackIntent(intent: Intent?) {
        if (intent?.action == android.provider.MediaStore.INTENT_ACTION_MEDIA_PLAY_FROM_SEARCH) {
            val playbackIntent = Intent(this, com.puzderwav.app.playback.MusicPlaybackService::class.java)
    ...
    private fun handleNavigationIntent(intent: Intent?) {
        ...
        val isDownloadsTarget = intent.action == com.puzderwav.app.data.download.TrackDownloadManager.ACTION_VIEW_DOWNLOADS ||
            intent.getStringExtra(com.puzderwav.app.data.download.TrackDownloadManager.EXTRA_NAVIGATE_TO) == Screen.Downloads.route
    ...
    private companion object {
        const val STARTUP_TAG = "PuzderWavStartup"
    }
}
