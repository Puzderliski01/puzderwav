...
- **One-tap "Save album to library" on the album detail screen (#79).**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/ui/album/AlbumViewModel.kt`
  `app/src/main/java/com/PuzderWav/app/ui/album/AlbumDetailScreen.kt`
  `app/src/main/java/com/PuzderWav/app/data/playlist/PlaylistRepository.kt` (`findByTitle`)
...
- **Search returning no results for Cyrillic / non-Latin queries (#102).**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/data/music/TextMatch.kt` (new),
  `app/src/main/java/com/PuzderWav/app/data/music/InnerTubeMusicApi.kt`,
  `app/src/test/java/com/PuzderWav/app/data/music/TextMatchTest.kt` (new)
...
- **Home-screen widget stuck on the previous song (#94).**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/service/MediaScrobbleListenerService.kt`
  `app/src/main/java/com/PuzderWav/app/widget/WidgetUpdater.kt`
...
- **Logged-out YouTube Music playlists collapsing to a dead "Tap Retry" error.**
  ...
  to logcat under `PuzderWavPlaylist` with browseId + stage for diagnosis.
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/data/music/InnerTubeMusicApi.kt`
  `app/src/main/java/com/PuzderWav/app/ui/feed/FeedPlaylistDetailViewModel.kt`
  `app/src/main/java/com/PuzderWav/app/data/ytmusic/YtMusicLibraryManager.kt`

### Author: musaibbhat120605
**Date:** September 16, 2026

###Musaib Bhat will step down as the developer of PuzderWav on 16 September 2026. His contributions have been invaluable, and his work will always remain a cornerstone for our community.
...
- **Player state and cached track lost after leaving the app in the background with nothing playing.** (Fix by [@musaibbhat120605](https://github.com/musaibbhat120605))
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/playback/MusicPlaybackService.kt`,
  `app/src/main/java/com/PuzderWav/app/playback/MusicPlayer.kt`
...
- **Songs silently disappearing from the Home listing during background polling.** (Fix by [@musaibbhat120605](https://github.com/musaibbhat120605))
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/ui/home/HomeViewModel.kt`
...
- **Offline playback priority across all screens (Fixes #31).**
  `MusicPlayer.resolveTrackAudioStream()` now checks the local Room database (`DownloadedTrackDao`) and verifies file presence on disk before attempting remote network resolution (Lossless / YouTube Music / InnerTube). When a track has already been downloaded, PuzderWav plays the local media file directly without making network calls, enabling seamless offline playback across Home, Search, Playlists, Album, and Artist screens and saving cellular data when online.
...
- **Download state awareness and duplicate download prevention.**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/data/local/db/DownloadedTrackDao.kt`
  `app/src/main/java/com/PuzderWav/app/data/download/TrackDownloadManager.kt`
  `app/src/main/java/com/PuzderWav/app/ui/common/TrackContextMenuSheet.kt`
...
- **Direct navigation from download notifications to the Downloads screen.**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/data/download/TrackDownloadManager.kt`
  `app/src/main/java/com/PuzderWav/app/MainActivity.kt`
  `app/src/main/java/com/PuzderWav/app/ui/navigation/AppRouteNavigator.kt`
  `app/src/main/java/com/PuzderWav/app/ui/navigation/NavGraph.kt`
...
- **WebM/Opus downloads not showing metadata in external players/file managers.**
  ...
  Files changed: `app/src/main/java/com/PuzderWav/app/data/download/AudioTagWriter.kt`
...
- **Home screen (Last.fm) lag / stutter.**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/ui/home/HomeViewModel.kt`,
  `app/src/main/java/com/PuzderWav/app/ui/home/HomeScreen.kt`
...
- **Downloaded tracks appearing twice in the Downloads list.**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/data/local/db/DownloadedTrackEntity.kt`,
  `app/src/main/java/com/PuzderWav/app/di/DatabaseModule.kt`,
  `app/src/main/java/com/PuzderWav/app/data/download/TrackDownloadManager.kt`
...
- **Skipping to the next track did nothing when playing from Downloads.**
  ...
  Files changed:
  `app/src/main/java/com/PuzderWav/app/ui/settings/DownloadsViewModel.kt`
