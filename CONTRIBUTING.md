# Contributing to PuzderWav

Thank you for your interest in contributing to PuzderWav. This document outlines the development workflow, code standards, and submission guidelines.
...
PuzderWav is built using modern Android architecture patterns:
